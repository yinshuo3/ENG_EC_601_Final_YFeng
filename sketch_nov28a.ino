//scanner mode, move right, does work, need more polish
...
#define ECHO_PINR 3
// defines variables
// 1st: Scanner Move left / right across the crack, move right is right -> middle -> left.
// move right
...
// 5 is too small to tolerate sensor errors, try 10mm
